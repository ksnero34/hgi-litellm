    ...
    <Card>
      <div className="space-y-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <Title>{t("toolsModels.mcp.costConfiguration")}</Title>
          <Tooltip title={t("toolsModels.mcp.costConfigurationHelp")}>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <Tooltip title={t("toolsModels.mcp.defaultCostPerQueryHelp")}>
            ...
            <InputNumber
              ...
              addonBefore="$"
            />
            <Text className="block mt-1 text-gray-500 text-sm">{t("toolsModels.mcp.defaultCostForAllTools")}</Text>
          </div>
          ...
          {tools.length > 0 && (
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700">
                ...
                <Tooltip title={t("toolsModels.mcp.toolSpecificCostsHelp")}>
                  <InfoCircleOutlined className="ml-1 text-gray-400" />
                </Tooltip>
              </label>
              <Collapse
        ...
        {(value.default_cost_per_query ||
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <Text className="text-blue-800 font-medium">{t("toolsModels.mcp.costSummary")}</Text>
            <div className="mt-2 space-y-1">
              {value.default_cost_per_query && (
                <Text className="text-blue-700">
                  {t("toolsModels.mcp.defaultCostSummary", {
                  ...
                  ([toolName, cost]) =>
                    ...
                    cost !== undefined && (
                      <Text key={toolName} className="text-blue-700">
                        {t("toolsModels.mcp.toolCostSummary", {
                          toolName,
                          cost: cost.toFixed(4),
                        })}
                      </Text>
