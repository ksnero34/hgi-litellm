...
export const NotificationsBell: React.FC = () => {
  ...
  const content = (
    <div className="max-w-[280px]">
      <PopoverTitle className="mt-0! mb-2!">{t("notifications.autoRouter.title")}</PopoverTitle>
      <PopoverDescription className="mb-3! text-sm leading-snug">
        {t("notifications.autoRouter.description")}
      </PopoverDescription>
      <div className="flex flex-wrap items-center gap-2">
        ...
        >
          {t("notifications.autoRouter.readDocs")}
        </a>
        {hasUnread ? (
