  ...
  return [
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={t("observabilityExtra.requestLogs.columns.time")}
          variant="dropdown-tristate"
        />
      ),
      size: 200,
      enableSorting: true,
    ...
    {
      id: "type",
      header: t("observabilityExtra.requestLogs.columns.type"),
      size: 90,
      enableSorting: false,
      meta: { skeleton: "badge" },
      cell: ({ row }) => {
    ...
    {
      id: "status",
      header: t("observabilityExtra.requestLogs.columns.status"),
      size: 100,
      enableSorting: false,
      meta: { skeleton: "badge" },
      cell: ({ row }) => {
        ...
        return (
          <StatusBadge
            ...
            label={t(
              isSuccess
                ? "observabilityExtra.requestLogs.status.success"
                : "observabilityExtra.requestLogs.status.failure",
            )}
          />
        );
      },
    },
    {
      ...
      header: t("observabilityExtra.requestLogs.columns.sessionId"),
      size: 120,
      enableSorting: false,
    ...
    },
    {
      ...
      header: t("observabilityExtra.requestLogs.columns.requestId"),
      enableSorting: false,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={t("observabilityExtra.requestLogs.columns.cost")}
          variant="dropdown-tristate"
        />
      ),
      size: 110,
          ...
          <div className="flex flex-col items-end">
            ...
            {isMultiCallSession && (
              <span className="text-[10px] text-gray-400">
                {t("observabilityExtra.requestLogs.columns.sessionTotal")}
              </span>
            )}
            {mcpCount > 0 && mcpSpend > 0 && (
              <span className="text-[10px] text-amber-600">
                {t("observabilityExtra.requestLogs.columns.includingMcpSpend", {
                  amount: getSpendString(mcpSpend),
                  count: mcpCount,
                })}
              </span>
            )}
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={t("observabilityExtra.requestLogs.columns.durationSeconds")}
          variant="dropdown-tristate"
        />
      ),
      enableSorting: true,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={t("observabilityExtra.requestLogs.columns.ttftSeconds")}
          variant="dropdown-tristate"
        />
      ),
      enableSorting: true,
    ...
    {
      id: "team_alias",
      header: t("observabilityExtra.requestLogs.columns.teamName"),
      size: 150,
      enableSorting: false,
    ...
    {
      id: "key_hash",
      header: t("observabilityExtra.requestLogs.columns.keyHash"),
      size: 110,
      enableSorting: false,
      cell: ({ row }) => (
        <IdCell
          value={readMetaString(row.original.metadata, "user_api_key")}
          variant="plain"
          onClick={onKeyHashClick}
        />
      ),
    },
    {
      id: "key_alias",
      header: t("observabilityExtra.requestLogs.columns.keyAlias"),
      size: 150,
      enableSorting: false,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={t("observabilityExtra.requestLogs.columns.model")}
          variant="dropdown-tristate"
        />
      ),
      size: 200,
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center space-x-2">
            ...
            <CellTooltip
              content={modelName}
              trigger={<span className="max-w-[15ch] truncate block">{modelName}</span>}
            />
          </div>
        );
      },
    },
    {
      ...
      header: ({ column }) => (
        <DataTableSortHeader
          column={column}
          title={t("observabilityExtra.requestLogs.columns.tokens")}
          variant="dropdown-tristate"
        />
      ),
      size: 140,
    ...
    },
    {
      id: "user",
      accessorKey: "user",
      header: t("observabilityExtra.requestLogs.columns.internalUser"),
      size: 150,
      enableSorting: false,
    ...
    },
    {
      ...
      header: t("observabilityExtra.requestLogs.columns.endUser"),
      size: 140,
      enableSorting: false,
    ...
    },
    {
      ...
      header: t("observabilityExtra.requestLogs.columns.tags"),
      size: 150,
      enableSorting: false,
      meta: { skeleton: "chips" },
      cell: ({ row }) => {
