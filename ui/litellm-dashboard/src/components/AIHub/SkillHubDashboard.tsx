...
const SkillHubDashboard: React.FC<SkillHubDashboardProps> = ({
  ...
  if (isLoading) {
    return <div className="text-center py-16 text-gray-400">{t("hubSkills.dashboard.loading")}</div>;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <ModelDataTable
          columns={skillHubColumns((skill) => setSelectedSkill(skill), copyToClipboard, t, publicPage)}
          data={filteredSkills}
          isLoading={false}
