          ...
          <div className={isEmbedded ? "w-full p-6" : "w-full px-8 py-12"}>
            ...
            {!isEmbedded && (
              <Card className="mb-10 p-8 bg-white border border-gray-200 rounded-lg shadow-xs">
                <h2 className="text-2xl font-semibold mb-6 text-gray-900">{t("hubSkills.hub.about")}</h2>
            ...
            {usefulLinks && Object.keys(usefulLinks).length > 0 && (
              <Card className="mb-10 p-8 bg-white border border-gray-200 rounded-lg shadow-xs">
                <h2 className="text-2xl font-semibold mb-6 text-gray-900">{t("hubSkills.hub.usefulLinks")}</h2>
            ...
            <Card className="p-8 bg-white border border-gray-200 rounded-lg shadow-xs">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="public-hub-tabs">
                <TabsList>
                  ...
                  {hasAgents && <TabsTrigger value="agents">{t("hubSkills.hub.agentHub")}</TabsTrigger>}
                  {hasMcpServers && <TabsTrigger value="mcp">{t("hubSkills.hub.mcpHub")}</TabsTrigger>}
                  <TabsTrigger value="skills">{t("hubSkills.hub.skillHub")}</TabsTrigger>
                </TabsList>

                {/* Models Tab */}
                <TabsContent value="models">
                  <div className="flex justify-between items-center mb-8">
                    <h2 className="text-2xl font-semibold text-gray-900">{t("hubSkills.hub.availableModels")}</h2>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-medium mb-3 text-gray-700">{t("hubSkills.hub.provider")}</p>
                      <Combobox
                        multiple
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-medium mb-3 text-gray-700">{t("hubSkills.hub.mode")}</p>
                      <MultiSelect
                        options={modeOptions}
                        value={selectedModes}
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-medium mb-3 text-gray-700">{t("hubSkills.hub.features")}</p>
                      <MultiSelect
                ...
                {hasAgents && (
                  <TabsContent value="agents">
                    <div className="flex justify-between items-center mb-8">
                      <h2 className="text-2xl font-semibold text-gray-900">{t("hubSkills.hub.availableAgents")}</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <div className="min-w-0">
                        <p className="text-sm font-medium mb-3 text-gray-700">{t("hubSkills.hub.skills")}</p>
                        <MultiSelect
                ...
                {hasMcpServers && (
                  <TabsContent value="mcp">
                    <div className="flex justify-between items-center mb-8">
                      <h2 className="text-2xl font-semibold text-gray-900">{t("hubSkills.hub.availableMcp")}</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <div className="min-w-0">
                        <p className="text-sm font-medium mb-3 text-gray-700">{t("hubSkills.hub.transport")}</p>
                        <MultiSelect
