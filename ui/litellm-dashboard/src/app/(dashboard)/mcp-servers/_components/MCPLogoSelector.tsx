  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-2">
        <span className="text-sm font-medium text-gray-700">{t("toolsModels.mcp.logo.label")}</span>
        <Tooltip title={t("toolsModels.mcp.logo.tooltip")}>
      ...
      {value && (
        <div className="flex items-center gap-3 mb-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
          <img
            ...
            alt={t("toolsModels.mcp.logo.selectedAlt")}
      ...
      <Input
        ...
        placeholder={t("toolsModels.mcp.logo.customUrlPlaceholder")}
