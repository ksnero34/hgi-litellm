  ...
  return (
    <div className="w-full h-full p-6">
      <Modal
        ...
        title={t("toolsModels.mcp.servers.deleteTitle")}
        onOk={confirmDelete}
        okText={isDeletingServer ? t("toolsModels.mcp.common.deleting") : t("toolsModels.mcp.common.delete")}
        onCancel={cancelDelete}
        cancelText={t("toolsModels.mcp.common.cancel")}
        cancelButtonProps={{ disabled: isDeletingServer }}
        okButtonProps={{ danger: true }}
        confirmLoading={isDeletingServer}
      >
        <div className="space-y-4">
          <AntdText className="text-gray-600">{t("toolsModels.mcp.servers.deleteWarning")}</AntdText>
            ...
            <div className="mt-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <Descriptions column={1} size="small" colon={false}>
                {serverToDelete.server_name && (
                  <Descriptions.Item
                    label={<span className="text-gray-500 text-sm">{t("toolsModels.mcp.common.name")}</span>}
                  >
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3">
            <Title>{t("toolsModels.mcp.servers.title")}</Title>
          ...
          <Text className="text-tremor-content mt-1">{t("toolsModels.mcp.servers.description")}</Text>
        </div>
      ...
      <TabGroup className="w-full h-full">
        <TabList className="flex justify-between mt-2 w-full items-center">
          <div className="flex">
            <Tab>{t("toolsModels.mcp.servers.tabs.all")}</Tab>
            <Tab>{t("toolsModels.mcp.servers.tabs.toolsets")}</Tab>
            <Tab>{t("toolsModels.mcp.servers.tabs.connect")}</Tab>
            {isAdminRole(userRole) && <Tab>{t("toolsModels.mcp.servers.tabs.semanticFilter")}</Tab>}
            {isAdminRole(userRole) && <Tab>{t("toolsModels.mcp.servers.tabs.networkSettings")}</Tab>}
            {isAdminRole(userRole) && (
              <Tab>
                    ...
                    <div className="flex items-center gap-6 bg-white rounded-lg px-4 py-3 border border-gray-200">
                      <div className="flex items-center gap-2">
                        ...
                        <Select value={selectedTeam} onChange={handleTeamChange} style={{ width: 220 }} size="middle">
                          ...
                          <Option value="personal">
                            <span className="font-medium">{t("toolsModels.mcp.servers.filters.personal")}</span>
                          </Option>
                      ...
                      <div className="flex items-center gap-2">
                        <Text className="text-sm font-medium text-gray-600 whitespace-nowrap">
                          ...
                          <Tooltip title={t("toolsModels.mcp.servers.filters.accessGroupHelp")}>
                        ...
                        >
                          <Option value="all">
                            <span className="font-medium">{t("toolsModels.mcp.servers.filters.allAccessGroups")}</span>
                          </Option>
                ...
                <div className="mt-4 w-full">
                  {isLoadingServers ? (
                    <div className="flex items-center justify-center rounded-lg border border-dashed border-gray-200 bg-white p-12">
                      <Spin tip={t("toolsModels.mcp.servers.loading")} />
                    </div>
