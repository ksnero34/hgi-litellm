      ...
      <Card className="w-full overflow-hidden rounded-xl shadow-md">
        <div className="grid h-auto w-full grid-cols-4 gap-4">
          ...
          <div className="col-span-1 flex flex-col bg-muted p-4">
            <h2 className="mt-2 mb-6 text-xl font-semibold">{t("toolsModels.mcp.toolsTab")}</h2>
            ...
            <div className="flex flex-col flex-1">
                ...
                <div className="mb-4 rounded-lg border border-border bg-card p-3">
                  <div className="mb-2 flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <p className="text-sm font-medium">{t("toolsModels.mcp.additionalHeaders")}</p>
                    </div>
                  ...
                  {!showHeaderInput && Object.keys(passthroughHeaders).length === 0 && (
                    <p className="text-xs text-muted-foreground">{t("toolsModels.mcp.additionalHeadersHelp")}</p>
                  )}
              ...
              <div className="flex flex-col flex-1 min-h-0">
                <p className="mb-3 flex items-center text-sm font-medium">
                  <Wrench className="mr-2 size-4" /> {t("toolsModels.mcp.availableTools")}
                  {toolsData.length > 0 && (
                ...
                {usesBrowserHeldToken && !oauthToken && (
                  <div className="rounded-lg border border-border bg-card p-4 text-center">
                    ...
                    <p className="mb-1 text-xs font-medium">{t("toolsModels.mcp.authenticationRequired")}</p>
                    <p className="mb-3 text-xs text-muted-foreground">{t("toolsModels.mcp.authenticateToViewTools")}</p>
                    <Button
                      size="sm"
                ...
                {(authorizationCodeNeedsAuth || authorizationCodeTokenRejected) && (
                  <div className="rounded-lg border border-border bg-card p-4 text-center">
                    ...
                    <p className="mb-3 text-xs text-muted-foreground">
                      {t("toolsModels.mcp.authenticateUpstreamToViewTools")}
                    </p>
                    <Button
                      size="sm"
                  ...
                  <>
                    ...
                    {toolsAreaLoading && (
                      <div className="flex flex-col items-center justify-center rounded-lg border border-border bg-card py-8">
                        ...
                        <p className="text-xs font-medium">{t("toolsModels.mcp.loadingTools")}</p>
                      </div>
                    )}
                    ...
                    {!toolsAreaLoading &&
                      ...
                      (!toolsData || toolsData.length === 0) && (
                        <div className="rounded-lg border border-border bg-card p-4 text-center">
                          ...
                          <p className="mb-1 text-xs font-medium">{t("toolsModels.mcp.noToolsAvailable")}</p>
                          <p className="text-xs text-muted-foreground">{t("toolsModels.mcp.noToolsForServer")}</p>
                        </div>
                      )}
                      ...
                      <>
                        {filteredTools.length === 0 ? (
                          <div className="rounded-lg border border-border bg-card p-4 text-center">
                            ...
                            <p className="mb-1 text-xs font-medium">{t("toolsModels.mcp.noToolsFound")}</p>
          ...
          <div className="col-span-3 flex flex-col">
            <div className="flex items-center justify-between border-b border-border p-4">
              <h2 className="mb-0 text-xl font-semibold">{t("toolsModels.mcp.toolTestingPlayground")}</h2>
            </div>
            ...
            <div className="flex-1 overflow-auto p-4">
              {!selectedTool ? (
                ...
                <div className="flex h-full flex-col items-center justify-center text-muted-foreground">
                  ...
                  <p className="mb-2 text-lg font-medium">{t("toolsModels.mcp.selectToolToTest")}</p>
                  <p className="max-w-md text-center text-sm">{t("toolsModels.mcp.selectToolToTestHelp")}</p>
                </div>
              ) : (
                /* Tool Test Panel */
