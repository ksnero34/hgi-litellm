...
describe("UsagePage", () => {
  ...
  describe("Export Data button", () => {
    ...
    it("should hide Export Data for an Admin Viewer", async () => {
      ...
      expect(screen.queryByText("Export Usage Data")).not.toBeInTheDocument();
    });
  });
  ...
  describe("Ask AI button", () => {
    ...
    it("should hide Ask AI and its panel for an Admin Viewer", async () => {
      mockUseAuthorized.mockReturnValue({
        ...nonAdminSession,
        userRole: "Admin Viewer",
        userRoleLabel: "Admin Viewer",
      ...
      expect(screen.queryByTestId("usage-ai-chat-panel")).not.toBeInTheDocument();
    });
  });
