...
const UIThemeSettings: React.FC<UIThemeSettingsProps> = ({ userID, userRole, accessToken }) => {
  ...
  return (
    <div className="w-full mx-auto max-w-4xl px-6 py-8">
      <div className="mb-8">
        <Title className="text-2xl font-bold mb-2">{t("operations.theme.title")}</Title>
        <Text className="text-gray-600">{t("operations.theme.description")}</Text>
      </div>
      <Card className="shadow-xs p-6">
        <div className="space-y-6">
          <div>
            <Text className="text-sm font-medium text-gray-700 mb-2 block">{t("operations.theme.logoUrl")}</Text>
            <TextInput
              ...
              className="w-full"
            />
            <Text className="text-xs text-gray-500 mt-1">{t("operations.theme.logoUrlHelp")}</Text>
          </div>
          <div>
            <Text className="text-sm font-medium text-gray-700 mb-2 block">{t("operations.theme.faviconUrl")}</Text>
            <TextInput
              ...
              className="w-full"
            />
            <Text className="text-xs text-gray-500 mt-1">{t("operations.theme.faviconUrlHelpWithFormats")}</Text>
          </div>
