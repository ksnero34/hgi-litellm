...
export function AccessGroupsPage() {
  ...
  return (
    <div className="p-6 px-12">
      <div className="mb-4">
        <PageHeader
          title={t("identity.accessGroups.title", { defaultValue: "Access Groups" })}
          subtitle={t("identity.accessGroups.subtitle", {
      ...
      <DeleteResourceModal
        ...
        resourceInformationTitle={t("identity.accessGroups.delete.info", {
