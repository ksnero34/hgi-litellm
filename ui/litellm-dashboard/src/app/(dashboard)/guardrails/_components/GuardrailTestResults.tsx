...
export function GuardrailTestResults({ results, errors }: GuardrailTestResultsProps) {
  ...
  return (
    <div className="space-y-3 pt-4 border-t border-gray-200">
      <h3 className="text-sm font-semibold text-gray-900">{t("safety.test.results")}</h3>
                ...
                {!isCollapsed && (
                  <>
                    <div className="bg-white border border-green-200 rounded-sm p-3">
                      <label className="text-xs font-medium text-gray-600 mb-2 block">{t("safety.test.output")}</label>
