...
def _numeric_metric(record: object, field: str) -> int | float:
...
def update_metrics(existing_metrics: SpendMetrics, record: DailySpendRecord) -> SpendMetrics:
    ...
    """
    prompt_tokens: Final = int(_numeric_metric(record, "prompt_tokens"))
    completion_tokens: Final = int(_numeric_metric(record, "completion_tokens"))
    ...
    existing_metrics.gateway_injected_caching_savings_spend += float(
        _numeric_metric(record, "gateway_injected_caching_savings_spend")
    )
    existing_metrics.autorouter_savings_spend += float(_numeric_metric(record, "autorouter_savings_spend"))
