...
def _add_guardrails_from_policies_in_metadata(
    ...
    policy_sources: Final[dict[str, str]] = {}
    ...
    verbose_proxy_logger.debug("Policy engine: resolving guardrails from key/team policies: %s", set(policy_sources))
...
async def add_guardrails_from_policy_engine(
    ...
    fetched_policy_ids: Final[dict[str, str]] = {}
