...
class LitellmTableNames(str, enum.Enum):
    ...
    TEAM_MEMBERSHIP_TABLE_NAME = "LiteLLM_TeamMembership"
    USER_TABLE_NAME = "LiteLLM_UserTable"
    KEY_TABLE_NAME = "LiteLLM_VerificationToken"
    ORGANIZATION_TABLE_NAME = "LiteLLM_OrganizationTable"
    ORGANIZATION_MEMBERSHIP_TABLE_NAME = "LiteLLM_OrganizationMembership"
...
class SpendLogsMetadata(TypedDict):
    ...
    additional_usage_values: dict | None
