...
class ProxyBaseLLMRequestProcessing:
    ...
    async def common_processing_pre_call_logic(
        ...
        # add_litellm_data_to_request predates that mutation. Synchronize after
        # refreshing so secret token maps removed by the guardrail cannot be
        # copied back into the persistent proxy request snapshot.
