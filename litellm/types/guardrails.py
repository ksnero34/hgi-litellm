...
class BaseLitellmParams(ContentFilterConfigModel):  # works for new and patch update guardrails
    ...
    unreachable_fallback: Literal["fail_closed", "fail_open"] = Field(
        ...
        description=(
            ...
            "'compresr', and 'presidio'. Most providers default to 'fail_closed'; Presidio defaults to 'fail_open' "
            "when this field is omitted. 'fail_closed' raises an error. 'fail_open' logs the failure and allows the request "
            "to proceed."
        ),
    )
