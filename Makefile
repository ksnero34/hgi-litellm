...
lint-basedpyright-budget-update: install-dev lint-fetch-base
	$(UV_RUN) python scripts/type_check_gate.py --base $(LINT_BASE) --update
...
lint-ruff-budget-update: install-dev lint-fetch-base
	$(UV_RUN) python scripts/ruff_strict_gate.py --base $(LINT_BASE) --update

lint-type-discipline-budget-update: install-dev lint-fetch-base
	$(UV_RUN) python scripts/type_discipline_gate.py --base $(LINT_BASE) --update

lint-test-quality-budget-update: install-dev lint-fetch-base
	$(UV_RUN) python scripts/test_quality_gate.py --base $(LINT_BASE) --update
